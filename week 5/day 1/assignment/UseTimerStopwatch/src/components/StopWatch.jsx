...
function useGoogletimer(props) {
    ...
    return {
        handleStart, hours, minutes, seconds, MiliSecond, show, handledStop, handleReset
    }

}
const StopWatch = (props) => {
    const { handleStart, hours, minutes, seconds, MiliSecond, show, handledStop, handleReset } = useGoogletimer(props)
    return (
        <div className="container">
            <h2 className="m-auto text-center p-4">{hours > 0 ? hours + "hr :" : ""} {minutes > 0 ? minutes + "m :" : ""} {seconds + "s"}:{MiliSecond} </h2>
            <div className="row">{
                show ?
