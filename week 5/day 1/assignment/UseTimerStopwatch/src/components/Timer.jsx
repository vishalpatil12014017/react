...
function useTimer(props) {
    ...
    return {
        hours,setHours,minutes,setMinutes,seconds,setSeconds,show,handleReset,handledStop,handleStart
    }
}
const Timer = (props) => {
    const {hours,setHours,minutes,setMinutes,seconds,setSeconds,show,handleReset,handledStop,handleStart}=useTimer(props)
    return (
        <div className="ali_centre">

            <div className="row">
                <div className="col-3"></div>
                <div className="pt-4 col-6" style={{ display: "flex" }}>
