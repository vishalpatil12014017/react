                                    ...
                                    <div className="row g-0 p-1">
                                        ...
                                        <div className="col-md-8">
                                            <div className="card-body">
                                                ...
                                                <p className="mt-0 mb-0"><a className="card-text" href={e.html_url} style={{ textDecoration: "none" }}>Github Profile</a></p>
                                                <p><a className="card-text" href={e.repos_url} style={{ textDecoration: "none" }}>View repos</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
